...
<div class="sub_top_menu">
    ...
    <ul class="menu_wrap container">
        <li class="menu_item <?php if($_GET["r"] == "std_db") echo "active"; ?>"><a href="./?r=std_db">슈페리어 더블</a></li>
        ...
        <li class="menu_item <?php if($_GET["r"] == "dx_oc_ondol") echo "active"; ?>"><a href="./?r=dx_oc_ondol">디럭스 오션 한실</a></li>
    ...
    <ul class="menu_wrap container">
        <li class="menu_item <?php if($_GET["r"] == "pr_oc_ondol") echo "active"; ?>"><a href="./?r=pr_oc_ondol">프리미어 오션 온돌</a></li>
