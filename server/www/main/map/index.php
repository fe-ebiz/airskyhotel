            ...
            <div class="value_map_info_top">
                <div class="value_map_info_item_wrap">
                    ...
                    <table class="map-tbl">
                        ...
                        <tr>
                            <th>대표번호</th>
                            <td>032) 720-6201(프론트), 1666-1243(예약실)</td>
                        </tr>
                        <tr>
                            <th>주변버스 정류장</th>
                            <td>
                        ...
                        <tr>
                            <th>여객선 이용</th>
                            <td>
                                월미도(월미선착장) ↔ 영종도(구읍배터) 여객선으로 이동가능<br><br>
                                - 매일 07시30분 부터 1시간마다 운행 (18시경 마지막 운행)<br>
                                - 요금(편도) : 대인 3,500원 / 학생 1,500원 (중고생) / 소인 1,000원 (초등생)<br>
                                - 차량선적가능 (별도요금) / 도서민 할인<br><br>
                                ※ 우리호텔에서 영종도 구읍배터까지 북쪽 도보 2분 (200m 거리)<br>
                            </td>
                        </tr>
                    </table>
                </div>
