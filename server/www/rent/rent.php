<link rel="stylesheet" href="http://static.hotelairsky.co.kr/svc/css/rent/init.css">
...
<div class="contents group-contents">
    <div class="sub">
        <div class="sub_top_menu">
            <h4 class="page_title">장단기숙박</h4>
            <h6 class="page_sub_title">
                수려한 녹음, 푸른 하늘과 드넓은 바다를 내집처럼 매일 매일 만나보세요!
            </h6>
        </div>
    </div>
</div>
<div class="rent-wrap clr">
    <div class="img-area">
        <figure class="nth-1"><img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/01.jpg" alt="에어스카이호텔 소개이미지"></figure>

        <figure class="nth-2"><img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/02_1.jpg" alt="에어스카이호텔 소개이미지"></figure>
        ...
        <div class="grid-wrap">
            ...
            <?php
                include("/home/ebizdev/hotelairsky.co.kr/www/rent/rent_price_w.php");
            ?>
        </div>

        <figure class="nth-2"><img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/02_2.jpg" alt="에어스카이호텔 소개이미지"></figure>

        <figure class="nth-3"><img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/03.jpg" alt="에어스카이호텔 소개이미지"></figure>
        <figure class="nth-4">
            <img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/04.jpg" alt="에어스카이호텔 소개이미지">
            <a href="http://hotelairsky.co.kr/rooms/?r=std_db" target="_blank" title="새 창" class="btn-linkOc2">
                <img src="http://img.hotelairsky.co.kr/svc/img/rent/detail/btn_moreRoom.png" alt="에어스카이호텔 객실안내 페이지로 이동">
            </a>
        </figure>
