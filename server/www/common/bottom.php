        ...
        <div class="group">
            ...
            <div class="sfa">
                <div class="split split-2">
                    <div class="inquiry-bar">
                        <a class="item item-1 clr">
                            ...
                            <!-- <span class="s2"><img src="<?=base_img?>/svc/img/common/i_call.png" alt="전화아이콘" class="i-tel">1666-6701</span> -->
                            <span class="s2"><img src="<?=base_img?>/svc/img/common/i_call.png" alt="전화아이콘" class="i-tel">1666-1243</span>
                        ...
                        <a class="item item-2 clr">
                            ...
                            <span class="s2"><img src="<?=base_img?>/svc/img/common/i_call.png" alt="전화아이콘" class="i-tel">033-820-0005</span>
                            <span class="s3">(주중/주말 06시 ~ 02시)</span>
                        </a>
                        <a class="item item-3 clr">
                            <p class="s1">단체문의<span class="s1-2">워크샵, 학생, 산업단체 / 단체이용 관련 문의</span></p>
                            <!-- <span class="s2"><img src="<?=base_img?>/svc/img/common/i_call.png" alt="전화아이콘" class="i-tel">010-9544-8281</span> -->
                            <span class="s2"><img src="<?=base_img?>/svc/img/common/i_call.png" alt="전화아이콘" class="i-tel">010-3066-4665</span>
                            <span class="s3">(주중/주말 06시 ~ 02시)</span>
                        </a>
                    </div>
                </div>
                <div class="split split-1">
                    <div class="logo-box">
                        <img src="<?=base_img?>/svc/img/symbol/footer_logo.png" alt="씨베이호텔" class="logo">
                        <img src="<?=base_img?>/svc/img/symbol/logo_f_goco.png" alt="고코투어" class="logo-goco">
                    ...
                    <div class="addr-bar">
                        <address class="addr">
                            <div class="info">
                                ...
                                <span class="item">인천광역시 중구 은하수로29번길 31</span>
                            </div>
                            <div class="info">
                            ...
                            <p class="copyright">COPYRIGHT © HOTEL AIR SKY. ALL RIGHTS RESERVED.</p>
                        </address>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/jquery/jquery.parallax.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/datepicker/js/bootstrap-datepicker.min.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/support/jquery.placeholder.min.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/jquery.word-break-keep-all.min.js"></script>
    <!--[if lt IE 9]>
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/support/flexibility.min.js"></script>
<![endif]-->

    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/lib/jssor/jssor.slider.min.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/lib/slick-master/slick/slick.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/common/javascript/func/function01.min.js"></script>
    <script type="text/javascript" src="<?=base_static?>/svc/js/script.min.js"></script>
