                        ...
                        <div class="evt-item">
                            <div class="bxBox">
                                <ul class="bxS fnBxSlider">
                                    ...
                                    <li class="li-2">
                                        <img src="http://img.ocean2you.co.kr/renew/event/event_koreatour.jpg" alt="에어스카이호텔 이벤트">
                                        <div class="evt-bx-box">
                                            <div class="evt-txt-box">
                                                <div class="evt-txt-container">
                                                    <p class="evt-bx-tit">대한민국 안전여행 참여 이벤트</p>
                                                    <p class="evt-bx-txt">
                                                        대한민국 안전여행 참여이벤트는 대한민국 39개 지자체 대상으로<br class="hidden-smxs">
                                                        숙박시설 및 먹거리 놀거리등 이용 영수증과 사진을 등록, 인증하면,<br>
                                                        15,000명 한에서 추첨을 통하여 국민관광상품권 5만원권을 제공해드립니다.<br>
                                                        전국민의 많은 참여를 부탁드립니다.<br>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="evt-tb-box">
                                <ul class="evt-tb cf">
                                    <li class="nth-1 t-full">
                                        <p class="p-lbl">행사명</p>
                                        <p class="p-txt">대한민국 안전여행 참여 이벤트</p>
                                    </li>
                                    <li class="nth-2 t-half">
                                        <p class="p-lbl">일정</p>
                                        <p class="p-txt">2020년 07월 01일 ~ 10월 31일</p>
                                    </li>
                                    <li class="nth-3 t-half">
                                        <p class="p-lbl">주최</p>
                                        <p class="p-txt">문화체육관광부, 한국관광개발연구원</p>
                                    </li>
                                    <li class="nth-4 t-half">
                                        <p class="p-lbl">장소</p>
                                        <p class="p-txt">전국대상</p>
                                    </li>
                                    <li class="nth-5 t-half">
                                        <p class="p-lbl">추가정보</p>
                                        <p class="p-txt"><a href="http://www.ktourtop10.kr/kr/event/info.php" target="_blank" title="새창 열림" rel="noopener noreferrer">▷자세히보기</a></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
